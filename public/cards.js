...
const cards = [
  ...
  {name: 'Firefly', type: 'warjack', bgPoints: 0, pointCost: 7, factions: ['cygnar']},
  {name: 'Lancer', type: 'warjack', bgPoints: 0, pointCost: 8, factions: ['cygnar']},
  {name: 'Cyclone', type: 'warjack', bgPoints: 0, pointCost: 12, factions: ['cygnar']},
  {name: 'Hammersmith', type: 'warjack', bgPoints: 0, pointCost: 12, factions: ['cygnar']},
  {name: 'Centurion', type: 'warjack', bgPoints: 0, pointCost: 16, factions: ['cygnar']},
  {name: 'Ironclad', type: 'warjack', bgPoints: 0, pointCost: 12, factions: ['cygnar']},
    // units:,
  {name: 'Rangers', type: 'unit', bgPoints: 0, pointCost: 7, factions: ['cygnar']},
  {name: '6x_Long_gunners', type: 'unit', bgPoints: 0, pointCost: 8, factions: ['cygnar']},
  ...
  {name: 'Madrak1', type: 'warlock', bgPoints: 29, pointCost: 0, factions: ['trollbloods']},
    // warbeasts:
  {name: 'Dire_Troll_Bomber', type: 'warbeast', bgPoints: 0, pointCost: 16, factions: ['trollbloods']},
  {name: 'Dire_Troll_Mauler', type: 'warbeast', bgPoints: 0, pointCost: 13, factions: ['trollbloods']},
  {name: 'Dire_Troll_Blitzer', type: 'warbeast', bgPoints: 0, pointCost: 16, factions: ['trollbloods']},
  {name: 'Troll_axer', type: 'warbeast', bgPoints: 0, pointCost: 8, factions: ['trollbloods']},
  ...
  {name: 'Thumper_crew', type: 'unit', bgPoints: 0, pointCost: 5, factions: ['trollbloods']},
    ...
    // solos:  
  {name: 'Janissa', type: 'solo', bgPoints: 0, pointCost: 3, factions: ['trollbloods']},
  ...
  {name: 'Gnarlhorn_Satyr', type: 'warbeast', bgPoints: 0, pointCost: 10, factions: ['circle']},
  {name: 'Gorax_rager', type: 'warbeast', bgPoints: 0, pointCost: 6, factions: ['circle']},
  {name: 'Wild_Argus', type: 'warbeast', bgPoints: 0, pointCost: 6, factions: ['circle']},
  {name: 'Winter_Argus', type: 'warbeast', bgPoints: 0, pointCost: 7, factions: ['circle']},
  {name: 'Woldwrath', type: 'warbeast', bgPoints: 0, pointCost: 34, factions: ['circle']},
  {name: 'Megalith', type: 'warbeast', bgPoints: 0, pointCost: 17, factions: ['circle']},
  {name: 'WoldWatcher', type: 'warbeast', bgPoints: 0, pointCost: 8, factions: ['circle']},
  {name: 'Woldwyrd', type: 'warbeast', bgPoints: 0, pointCost: 8, factions: ['circle']},
  {name: 'Woldwarden', type: 'warbeast', bgPoints: 0, pointCost: 13, factions: ['circle']},
    // units:
  {name: 'Druids', type: 'unit', bgPoints: 0, pointCost: 7, factions: ['circle']},
  {name: '3x_Skinwalkers', type: 'unit', bgPoints: 0, pointCost: 8, factions: ['circle']},
  {name: '5x_Skinwalkers', type: 'unit', bgPoints: 0, pointCost: 13, factions: ['circle']},
  {name: '5x_Skinwalkers+commander', type: 'unit', bgPoints: 0, pointCost: 16, factions: ['circle']},
  {name: 'Shifting Stones', type: 'unit', bgPoints: 0, pointCost: 3, factions: ['circle']},
    // solos:  
  {name: 'Lord_of_the_Feast', type: 'solo', bgPoints: 0, pointCost: 5, factions: ['circle']},
  {name: 'Druid_wilder', type: 'solo', bgPoints: 0, pointCost: 3, factions: ['circle']},
  ...
  {name: 'Destroyer', type: 'warjack', bgPoints: 0, pointCost: 13, factions: ['khador']},
    // units:
  ...
  {name: 'Reaper', type: 'warjack', bgPoints: 0, pointCost: 11, factions: ['cryx']},
  {name: 'Deathripper', type: 'warjack', bgPoints: 0, pointCost: 5, factions: ['cryx']},
  {name: 'Defiler', type: 'warjack', bgPoints: 0, pointCost: 7, factions: ['cryx']},
  {name: 'Desecrator', type: 'warjack', bgPoints: 0, pointCost: 12, factions: ['cryx']},
  {name: 'Harrower', type: 'warjack', bgPoints: 0, pointCost: 13, factions: ['cryx']},
  {name: 'Leviathan', type: 'warjack', bgPoints: 0, pointCost: 14, factions: ['cryx']},
  {name: 'Kraken', type: 'warjack', bgPoints: 0, pointCost: 32, factions: ['cryx']},
  {name: 'Sepulcher', type: 'warjack', bgPoints: 0, pointCost: 34, factions: ['cryx']}, 
  {name: 'Deathjack', type: 'warjack', bgPoints: 0, pointCost: 18, factions: ['cryx']}, 
    // units:
  {name: '6x_satyrix_bwitches', type: 'unit', bgPoints: 0, pointCost: 7, factions: ['cryx']},
  {name: '10x_satyrix_bwitches', type: 'unit', bgPoints: 0, pointCost: 11, factions: ['cryx']},
  ...
  {name: '3x_bane_riders', type: 'unit', bgPoints: 0, pointCost: 11, factions: ['cryx']},
    // solos:
  {name: 'Skarlock_thrall', type: 'solo', bgPoints: 0, pointCost: 3, factions: ['cryx']},
  {name: 'Tartarus', type: 'solo', bgPoints: 0, pointCost: 5, factions: ['cryx']},
  {name: 'Pistol_wraith', type: 'solo', bgPoints: 0, pointCost: 4, factions: ['cryx']},
  {name: 'Necrotech', type: 'solo', bgPoints: 0, pointCost: 1, factions: ['cryx']},
  ...
  {name: 'Alten_Ashley', type: 'solo', bgPoints: 0, pointCost: 5, factions: ['crucible', 'circle', 'cygnar', 'khador', 'protectorate', 'trollbloods']},
  ...
  {name: '3xGatorman_posse', type: 'unit', bgPoints: 0, pointCost: 8, factions: ['circle', 'legion', 'skorne', 'trollbloods']},
  {name: '5xGatorman_posse', type: 'unit', bgPoints: 0, pointCost: 13, factions: ['circle', 'legion', 'skorne', 'trollbloods']},
  {name: 'Totem_hunter', type: 'solo', bgPoints: 0, pointCost: 5, factions: ['circle', 'legion', 'skorne', 'trollbloods']},
